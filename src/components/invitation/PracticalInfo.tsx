...
const icons: Record<string, React.ReactElement> = {
  car: (
    <svg className="w-6 h-6 text-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M5 11l1.5-4.5A2 2 0 0 1 8.4 5h7.2a2 2 0 0 1 1.9 1.5L19 11m-14 0h14m-14 0v6m14-6v6M7 7v2m10-2v2M5 13h14"/>
    </svg>
  ),
  bed: (
  ...
  shirt: (
    <svg className="w-6 h-6 text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M2 7h20v5H2zM12 22V7M12 7S10 3 7 3 4 7 6 7m6 0s2-4 5-4 3 4 1 4"/>
    </svg>
  ),
  bus: (
    <svg className="w-6 h-6 text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  phone: (
    <svg className="w-6 h-6 text-indigo-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 3.09 4.18 2 2 0 0 1 5.11 2h3a2 2 0 0 1 2 1.72c.36 1.55 1.38 2.82 2.68 3.78a10 10 0 0 0 4.53 1.52l.56.07a2 2 0 0 1 1.72 2z"/>
    </svg>
  ),
  info: (
...
// Mapping emojis vers noms d'icônes
...
// Mapping des icônes (supports emojis et noms)
function getIcon(iconKey: string): React.ReactElement | null {
  // Si c'est un emoji, convertir
