...
export const EVENT_IDENTITIES: Record<EventType, EventIdentity> = {
  ...
  baby_shower: {
    ...
    darkPalette: {
      ...
      text: '#D8E8F8',
      textMuted: '#7A9BB5',
      border: 'rgba(167, 199, 231, 0.25)',
      glassBg: 'rgba(8, 12, 20, 0.85)',
    },
    mood: {
  ...
  engagement: {
    ...
    darkPalette: {
      ...
      text: '#F8D8E8',
      textMuted: '#9A6B80',
      border: 'rgba(232, 160, 191, 0.25)',
      glassBg: 'rgba(18, 5, 10, 0.88)',
    },
    mood: {
